...
class dc_motor:
    ...
    # Method to directly set the DC motor speed
...
class shoot_mode:
    ...
    def control_button():
        global SHOOTING, CONVEYER_POWER
        ...
        if gamepad.is_key_pressed("N2"):
            if SHOOTING:
                CONVEYER_POWER = util.restrict(CONVEYER_POWER - 5, 80, 100)
            else:
                CONVEYER_POWER = 100
            conveyer.set_power(CONVEYER_POWER)
